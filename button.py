...
#-----------Text-----------
about = 'Я создал бота, способного получать статистику с аккаунта WoT Blitz. Разработкой данного проекта занимался один человек, бот без рекламы, и я не являюсь партнёром или сотрудником компании Wargaming. Я буду благодарен если вы поделитесь этим ботом со своимми друзьями. Спасибо за использование! По вопросам сотрудничества писать сюда: @Fit4a'
