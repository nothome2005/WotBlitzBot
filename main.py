...
def ping_timer():
    ...
    while True:
        req.get_request_simple('https://wotblitzgram.herokuapp.com/')
        print('Herok wake up!')
...
async def command_help(msg: types.Message):
    await bot.send_message(msg.from_user.id,'Введите команду:/statist <Nickname> <Region>. Где Nickname - это имя игрового аккаунта, а Region - соотвественно регион сервера. Важно использовать сокращение такого вида: ru, eu, na, asia')
